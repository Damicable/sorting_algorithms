...
/**
 * swapNodes - This swaps two adjacent nodes in a doubly linked list
...
/**
 *  cocktail_sort_list - This sorts elements of a doubly linked list in
 *  ascending order using cocktail sort scheme
