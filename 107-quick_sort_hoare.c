...
/**
 * hoare_partition - The Hoare partition scheme function is used to
 * partition the array
 * @array: Array to be partitioned
 * @down: The starting index of the partition
 * @up: Ending index of the partition
...
/**
 * hoare_recursive - This function sorts the array of integers by
 * separating into partitions, using Hoare quick sort
...
/**
 * quick_sort_hoare - This function sorts array of integers in ascending
 * order using the Hoare quick sort scheme alogrithm
